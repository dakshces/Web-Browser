...
public class Stylesheet {
	 ...
	 * 
	 * @param rules is an {@code ArrayList} of Rule
	 */
 ...
 * 
 * <p>
 * A {@code Rule} object stores the selectors and the declarations in separate
...
class Selector implements Comparable<Selector> {
	...
	/**
	 * Constructs a {@code Selector} object with zero {@code Specificity}
	 */
	public Selector() {
